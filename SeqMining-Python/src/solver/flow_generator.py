    ...
    def generate_flow_spec(self):
        ...
        for flow in self.flow_list:
            ...
            while i < len(flow)-1:
                ...
                edge_list.append(s_edge)
                i += 1
            flow_table.append(edge_list)
            flow_idx += 1
        ...
        for flow in flow_table:
            ...
            while i < len(flow)-1:
                ...
                self.solver.add(edge_1_z3var >= 0)
        ...
        for flow in flow_table:
            ...
            self.solver.add(Implies(assume_z3var, edge_0_z3var > 0))
        ...
        self.status = True if self.solver.check() == sat else False

        zero_flow_list = flow_table
        iter = 0
