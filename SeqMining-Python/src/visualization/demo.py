...
prefix_string = input('Prefix for sequences to show: ')
prefix = []
...
pt.msg_file = './tests/def.msg' # specify the msg definition file (default is large.msg), best practice is to specify the starting and terminating messages in this file by #
pt.sol_file = './tests/sol.txt'# specify the solution file
